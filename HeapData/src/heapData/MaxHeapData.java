...
public class MaxHeapData<T extends Comparable<T>>
{
	/**
	 * Global Variables
	 */
	...
	private T[] heapArray;// Max-Heap array from (generic data form)
	private MaxHeapData<T> left,right;
	 ...
	 */
	public void Max_Heap_Insert(T value)
	{
